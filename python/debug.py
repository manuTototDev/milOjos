...
try:
    ...
    print("Consola de Debug: Brazo1(0-3), Brazo2(4-7), Brazo3(8-11)")
...
# Crear Sliders (4 por cada uno de los 3 brazos)
...
try:
    while True:
        ...
        # El formato es: $v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,1\n
        cmd = "$" + ",".join(map(str, vals)) + ",1\n"
        arduino.write(cmd.encode())
        
        # Monitor visual
        img = np.zeros((150, 500, 3), np.uint8)
        cv2.putText(img, f"Enviando 12 canales + Modo 1", (20, 50), 1, 1.2, (0,255,0), 2)
